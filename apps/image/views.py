...
class UploadImage(CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            path_hubconfig = r"C:\Users\dell\Desktop\django_yolo_api\yolov5_code"
            # or any custom trained model
            path_weightfile = r"C:\Users\dell\Desktop\django_yolo_api\yolov5_code\models\weight\best.pt"
